...
@Value(
	"${app.description:A comprehensive task management system with user authentication and"
	...
	return new OpenAPI()
		...
		.servers(
			List.of(
				...
				new Server().url("https://api.smarttask.com").description("Production Server")))
		.components(
			new Components()
				.addSecuritySchemes(
					"bearerAuth",
