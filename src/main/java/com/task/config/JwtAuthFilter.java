...
protected void doFilterInternal(
	...
	handleSecurityException(
		response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Security processing error");
	return;
	}
...
private void handleSecurityException(HttpServletResponse response, int status, String message)
	throws IOException {
