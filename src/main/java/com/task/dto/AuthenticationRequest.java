...
/**
 * DTO for authentication requests (login/register). Contains validation constraints for user input.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
@Pattern(
	...
	message =
		"Password must contain at least one digit, one lowercase, one uppercase letter and one"
			+ " special character")
